...
const _routes = [
  {
    ...
    component: () => import('./about-a0078d46.mjs').then((m) => m.default || m)
  },
  {
    ...
    component: () => import('./index-6e48559d.mjs').then((m) => m.default || m)
  }
];
...
const layouts = {
  default: () => import('./default-e699df56.mjs').then((m) => m.default || m),
  home: () => import('./home-24ec4f69.mjs').then((m) => m.default || m)
};
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import('./error-component-7f7fe39a.mjs').then((r) => r.default || r));
